...
export function HeroSection() {
  return (
    <SectionShell className="pb-16 pt-28 sm:pb-20 sm:pt-32 lg:pt-34">
      ...
      <SectionInner className="relative grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.05}>
            <h1 className="mt-5 max-w-[13ch] text-5xl font-semibold leading-[0.95] text-white sm:text-6xl lg:text-[4.8rem]">
